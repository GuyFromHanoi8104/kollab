...
if __name__ == "__main__":
    file_path = "/srv/storage/talc3@storage4.nancy.grid5000.fr/multispeech/calcul/users/ptuannam/agentic-rag-recommendation-engine/sources/netflix_data.xlsx - Sheet 1 - netflix_titles.csv"
    ...
    try:
        ...
        print("client ready:", is_ready)  # Should print: `True`
        
        if is_ready:
            print("Creating collection 'netflix_data_system_full'...")
            netflix_data = client.collections.create(
                name="netflix_data_system_full",
        ...
        # Guarantee client closes safely even if an upload exception occurs
        client.close()
